...
FlareQENotionDataLlamaIndex = {
    'data_args': {'output_dir': 'DataHouse/Data/Llama_index/notion-ingest-output',
                  ...
                  'store': 'simple',
                  'store_settings': {'persistent_path': 'DataHouse/Data/Llama_index/rawData/documents'},
                  'store_name': 'docstore.json'
                  },
    'retriever_args': {'index_type': 'VectorStoreIndex', 'retriever_type': 'VectorIndexRetriever',
                       'retriever_kwargs': {'similarity_top_k': 10, 'verbose': True},
                       'node_parsers': {'SentenceWindowNodeParser': {'window_size': 6, 'window_metadata_key': 'window',
    ...
    'llm_args': {'llm_provider': 'llama-index-huggingface',
                 ...
                 'cache_dir': '/Users/bhargavvankayalapati/.cache//huggingface/hub',
                 'local_files_only': True, 'context_window': 4096,
                 'max_new_tokens': 512,
                 'generate_kwargs': {"temperature": 0.001, "top_k": 50, "top_p": 0.95,
                                     'do_sample': False},
                 'tokenizer_max_length': 4096,
                 'stopping_ids': (50278, 50279, 50277, 1, 0),
                 },
    'query_engine_args': {'query_engine_type': 'ReActAgent',
                          'query_engine_tools': [{'query_engine_type': 'RetrieverQueryEngine',
                                                 'index_type': 'VectorStoreIndex',
                                                 'metadata': {'name': 'RetrieverQueryEngine',
                                                              'description': 'RetrieverQueryEngine based on VectorStoreIndex'},
                                                 },
                                                 {'query_engine_type': 'RetrieverQueryEngine',
                                                  'index_type': 'VectorStoreIndex',
                                                  'metadata': {'name': 'RetrieverQueryEngine',
                                                               'description': 'RetrieverQueryEngine based on VectorStoreIndex'},
                                                  },
                          ...
                          'node_postprocessors': {'MetadataReplacementPostProcessor': {'target_metadata_key': 'window'},
                                                  'CohereRerank': {'top_n': 2}},
                          'callback_manager': None,
                          'use_async': False},
    'rag_dataset_generation_args': {'raw_data_dir': None,
                                    'doc_store_path': 'DataHouse/Data/Llama_index/rawData/documents',
    ...
    'evaluation_args': {'project_id': '9500d44e-8059-46a5-9fe1-c4009715644b',
                        ...
                        'eval_output_dir': 'Evaluation/EvaluationResults/RetrievalQE'}
}
