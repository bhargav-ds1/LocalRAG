...
VectorIndexAutoRetrievalConfig = {
    'data_args': {'output_dir': 'DataHouse/Data/Unstructured_IO/notion-ingest-output',
                  'download_dir': 'DataHouse/Data/Unstructured_IO/rawData',
                  'work_dir': 'DataHouse/Data/Unstructured_IO/workDir',
                  'page_ids': ['fb1c47e9cbe54729b5fd0c9330cef866'],
                  'database_ids': None,
                  're_download': True, 'verbose': True, 'recursive': False, 'get_embeddings': False,
                  ...
                  'store': 'chroma', 'store_settings': None, 'store_name': 'testCollection1'},
    'retriever_args': {'index_type': 'VectorStoreIndex', 'retriever_type': 'VectorIndexRetriever',
                       'create_embeddings': True,
                       'raw_data_dir': 'DataHouse/Data/Unstructured_IO/rawData',
                       'embedding_provider': 'langchain-huggingface',
                       'embedding_model_name': 'sentence-transformers/all-MiniLM-L12-v2',
                       'chunk_size': 1024,
    ...
    'evaluation_args': {'project_id': '9500d44e-8059-46a5-9fe1-c4009715644b',
                        ...
                        'eval_output_dir':'Evaluation/EvaluationResults/VectorIndexAutoRetrieval'}
}
