...
RetrievalQueryEngineNotionReciprocalRerankFusionRetriever = {
    ...
    'retriever_args': {'index_type': 'VectorStoreIndex', 'retriever_type': 'QueryFusionRetriever',
                       'retriever_tools': [{'retriever_type': 'VectorIndexRetriever',
    ...
    'llm_args': {'llm_provider': 'llama-index-huggingface',
                 ...
                 'llm_model_path': '/Users/bhargavvankayalapati/.cache/huggingface/hub/models--mistralai--Mixtral-8x7B-Instruct-v0.1/snapshots/1e637f2d7cb0a9d6fb1922f305cb784995190a83/',
