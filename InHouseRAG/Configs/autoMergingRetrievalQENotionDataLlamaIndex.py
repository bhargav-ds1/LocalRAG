...
AutoMergingRetrievalQENotionDataLlamaIndex = {
    ...
    'retriever_args': {'index_type': 'VectorStoreIndex', 'retriever_type': 'AutoMergingRetriever',
                       # introduce a HierarchicalNodeParser here
                       'retriever_kwargs': {'similarity_top_k': 6, 'verbose': True},
    ...
    'query_engine_args': {'query_engine_type': 'RetrieverQueryEngine',
                          ...
                          'node_postprocessors': {'CohereRerank': {'top_n': 2}},
    ...
    'evaluation_args': {'project_id': '9500d44e-8059-46a5-9fe1-c4009715644b',
                        ...
                        'eval_output_dir': 'Evaluation/EvaluationResults/AutoMergingRetrievalQE'}
}
