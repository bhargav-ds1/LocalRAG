...
RouterRetriverWithBm25andVectorIndexRetriever = {
    ...
    'retriever_args': {'index_type': 'VectorStoreIndex', 'retriever_type': 'RouterRetriever',
                       'retriever_tools': [{'retriever_type': 'BM25Retriever',
