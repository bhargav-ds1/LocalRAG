...
class RagEvaluatorLocal:
    def __init__(
        ...
        if judge_llm is None:
            raise ValueError('Provide an LLM which is used to judge the responses')
        else:
    ...
    def _save_evaluations(self):
        ...
        with open(self.eval_output_dir + "/_evaluations.json", "w") as json_file:
    ...
    def _prepare_and_save_benchmark_results(self):
        ...
        # save mean_scores_df
        mean_scores_df.to_csv(self.eval_output_dir + "/benchmark.csv")
